...
function metaFor(role: string, faction: string): RoleMeta {
  ...
  const cardBase = '' // unused — portrait carries its own transparent background
  const map: Record<string, RoleMeta> = {
    villager: {
      ...
      art: `${A}/portraits/roles/portrait_villager_male_01_bust.png`, cardBase,
    },
    wolf: {
      label: '狼人', camp: '狼人阵营', campTone: 'wolf',
      description: '你是狼人，每晚和狼队商议刀人。',
      ability: '夜晚与狼队投票决定击杀目标。白天可悍跳神职、误导好人、或自爆终结发言。',
      art: `${A}/portraits/roles/portrait_werewolf_01_bust.png`, cardBase,
    },
    werewolf: {
      label: '狼人', camp: '狼人阵营', campTone: 'wolf',
      description: '你是狼人，每晚和狼队商议刀人。',
